                    ...
                    try {
                        while (true) {
                            ...
                            if (str.startsWith("/auth")) {
                                ...
                                String id = AuthService.getIdByLoginAndPass(tokens[1], tokens[2]);
                                if (networkNick != null) {
                                    sendMsg("/authok " + id);
                                    nick = networkNick;
                                    server.subscribe(Lesson_3.Server.ClientHandler.this);
                        ...
                        server.unsubscribe(Lesson_3.Server.ClientHandler.this);
                        String nickList = "/clientlist" + server.nickList();
                        server.broadcastMsg(nickList);
                    }
                    return "";
